 ...
 * @author Upendra
 */
public class Update_RecieverController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        go.setStyle("-fx-background-color:blue;-fx-text-fill:white");
    ...
    private void handleGoButtonAction(ActionEvent event) 
    {
        update.setStyle("-fx-background-color:blue;-fx-text-fill:white");
        clear.setStyle("-fx-background-color:blue;-fx-text-fill:white");
        go.setStyle("-fx-background-color:green;-fx-text-fill:white");
        if(!checkuser())
        {
            String user = name.getText();
            Receiver_Fetcher rf = new Receiver_Fetcher();
            String gip = rf.getip(user);
            ip.setText(gip);
        }
        else
        {
    ...
    private void handleUpdateButtonAction(ActionEvent event) 
    {
        ...
        if(checkall())
        {
            ...
            Receiver_Updator ru = new Receiver_Updator();
            if(ru.update(nam, ipp))
            {
                Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                alert.setTitle("Success");
                alert.setHeaderText(null);
                alert.setContentText("Receiver Updated Successfully");
                alert.showAndWait();
            }
            else
            {
                ...
                alert.setHeaderText(null);
                alert.setContentText("Reciever is not updated\nPlease try again later...");
                alert.showAndWait();
            }
        }  
        else
